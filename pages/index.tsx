...
function HomePage(): JSX.Element {
    ...
    const [rosterTypeCoverage, setRosterTypeCoverage] =
        useState<RosterTypeCoverage>({
            covered: [],
            notCovered: [],
            percentage: 0,
        });
    ...
    function getTypesCollection() {
        ...
        typesCollection.typesStrongAgainst = removeDuplicates(
            typesCollection.typesStrongAgainst
        );
        typesCollection.typesWeakAgainst = removeDuplicates(
            typesCollection.typesWeakAgainst
        );
    ...
    function checkTypeCoverage() {
        ...
        const notCoveredTypes = removeDuplicates(
            [...[...new Set([...typesWeakAgainst])], ...POKEMON_TYPES].filter(
                (type) => {
